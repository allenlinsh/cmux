...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.browser, "dev-host-no-cache", String(localized: "settings.browser.devHostNoCache", defaultValue: "Always Fetch Fresh Content from Local Dev Servers"), "browser.disableCacheForDevHosts localhost cache stale fresh hard reload dev server no-cache turbopack vite next"),
